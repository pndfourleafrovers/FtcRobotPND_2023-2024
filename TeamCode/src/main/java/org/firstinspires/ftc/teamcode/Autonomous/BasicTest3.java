...
import org.firstinspires.ftc.teamcode.Objects.RedProp;
import org.firstinspires.ftc.teamcode.Mixed.AprilAuto;
...
//@Disabled
@Autonomous(name="BasicT3", group="Autonomous")
public class BasicTest3 extends LinearOpMode{
...
//April tag detection and drive to.
        while (opModeIsActive())
        {
            targetFound = false;
            desiredTag  = null;
            DESIRED_TAG_ID = Position + 3; // = whatever we decided to name the variable at the beginning, +3 for red

package org.firstinspires.ftc.teamcode.Archive.RedFront;
...
@Autonomous(name="RedFrontDownRight", group="Autonomous")
//@Disabled
public class RedFrontDownRight extends LinearOpMode {

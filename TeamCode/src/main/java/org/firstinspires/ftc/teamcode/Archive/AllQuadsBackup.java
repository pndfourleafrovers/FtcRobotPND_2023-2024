...
@Autonomous(name="AllQuadsBackup", group="Autonomous")
@Disabled
public class AllQuadsBackup extends LinearOpMode {
    ...
    int Position;
    double[] distToStrafeAtPark ={20, 26, 33, 0};
    private Servo pmmA;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (ENDGAME){
                ...
                sleep(2000);
                if(quadrant==3) {
                    strafeRight(distToStrafeAtPark[Position], .5);
                } else {
                    strafeLeft(distToStrafeAtPark[Position],.5);
                }
                driveForward(8,0.5);
                sleep(3000);
                requestOpModeStop();
            ...
            if (detectProp) {
                if (objectDetectedLeft&&quadrant==4) {
                    ...
                    findAprilTag = true;
                    detectProp = false;
                } else if (objectDetectedRight&&quadrant==4) {
